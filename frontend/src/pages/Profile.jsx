...
const Profile = () => {
  ...
  const handleImageChange = (e) => {
    ...
    if (file) {
      ...
      reader.onloadend = () => {
        ...
        setFormData(prev => ({
          ...prev,
          avatar: reader.result // In a real app, this would be the file to upload
        }));
      };
  ...
  return (
    <div style={{ 
      ...
      overflow: 'hidden' // Enforce no scroll on container
    }}>
      <div style={{ 
        position: 'relative',
        ...
        <div style={{ 
          ...
          marginTop: '-65px',
          overflowY: 'auto', // Allow internal content scroll if absolutely necessary on tiny screens
          ...
          <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-end', marginBottom: '1.5rem' }}>
            ...
            <div style={{ 
              ...
              <div style={{
                ...
                height: '100%',
                borderRadius: '50%',
                border: '6px solid #1a1a1a', // Matches typical dark bg
                background: '#2a2a2a',
                overflow: 'hidden',
                display: 'flex',
                alignItems: 'center',
